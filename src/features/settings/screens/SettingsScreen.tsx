...
const SettingRow: React.FC<SettingRowProps> = ({
  icon, label, value, onValueChange, type = 'toggle', onPress, valueLabel,
}) => (
  <TouchableOpacity
    style={styles.row}
...
export const SettingsScreen: React.FC = () => {
  ...
  useEffect(() => {
    loadSettings<AppSettings>().then((saved) => {
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.white, borderRadius: 12, marginHorizontal: 16, elevation: 1, overflow: 'hidden' },
  row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 14 },
  rowLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  rowIcon: { width: 32, height: 32, borderRadius: 8, backgroundColor: colors.primary + '12', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
